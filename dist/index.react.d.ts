...
interface UseCheckboxReturnType<InputType extends Element, LabelType extends Element> extends 
 ...
 * @compositeParams
 */
declare function useDialog<FocusContainerElement extends Element, SourceElement extends Element, DialogElement extends Element, TitleElement extends Element>({ dismissParameters, escapeDismissParameters, focusTrapParameters, activeElementParameters, backdropDismissParameters, 
//lostFocusDismissParameters,
modalParameters, refElementParameters, labelParameters, ...void1 }: UseDialogParameters<DialogElement, TitleElement>): UseDialogReturnType<FocusContainerElement, SourceElement, DialogElement, TitleElement>;
...
declare const ListboxItem: <ListboxItemElement extends Element>({ unselectable, getText, untabbable, index, render, selected, getSortValue, allowRepeatPresses, excludeEnter, excludePointer, longPressThreshold, onPressingChange, onMultiSelect, onElementChange, onMount, onUnmount, onCurrentFocusedChanged, onCurrentFocusedInnerChanged, focusSelf, ...subInfo }: ListboxItemProps<ListboxItemElement, ListboxInfo<ListboxItemElement>>) => VNode$0<{}>;
...
declare const Progress: <IndicatorElement extends Element, LabelElement extends Element>({ tagProgressIndicator, ariaLabel, max, render, value, valueText, imperativeHandle }: ProgressProps<IndicatorElement, LabelElement>) => import("preact-prop-helpers").JSX.Element;
...
declare function Slider({ max, min, onAfterChildLayoutEffect, onChildrenMountChange, render, imperativeHandle, onChildrenCountChange }: SliderProps<SliderThumbInfo>): import("preact").JSX.Element;
declare function SliderThumb<ThumbElement extends Element, ProgressIndicatorElement extends Element, ProgressLabelElement extends Element>({ label, tag, value, max, min, index, render, valueText, imperativeHandle, onValueChange, info }: SliderThumbProps<ThumbElement>): import("preact").JSX.Element;
...
declare const TableCell: <CellElement extends Element>({ index, getText, focusSelf, untabbable, tagTableCell, render, colSpan, imperativeHandle, getSortValue, info }: TableCellProps<CellElement, TableCellInfo<CellElement>>) => import("preact").JSX.Element;
type TabsProps<TabContainerElement extends Element, TabElement extends Element, TabLabelElement extends Element, M extends TabInfo<TabElement>> = GenericComponentProps<UseTabsReturnType<TabContainerElement, TabElement, TabLabelElement, M>, Get11<UseTabsParameters<TabContainerElement, TabElement, M>, "labelParameters", "linearNavigationParameters", "rearrangeableChildrenParameters", "rovingTabIndexParameters", "singleSelectionParameters", "sortableChildrenParameters", "staggeredChildrenParameters", "tabsParameters", "typeaheadNavigationParameters", "singleSelectionParameters", "refElementParameters">, "orientation" | "ariaLabel">;
type TabProps<TabElement extends Element, M extends TabInfo<TabElement>> = GenericComponentProps<UseTabReturnType<TabElement, M>, Get5<UseTabParameters<TabElement, TabInfo<TabElement>>, "pressParameters", "textContentParameters", "info", "hasCurrentFocusParameters", "refElementParameters">, "index" | "getSortValue"> & {
    info?: OmitStrong$0<M, keyof TabInfo<TabElement>>;
};
type TabPanelProps<PanelElement extends Element, M extends TabPanelInfo> = GenericComponentProps<UseTabPanelReturnType<PanelElement>, Get$0<UseTabPanelParameters<M>, "info">, "index"> & {
...
*/
type ToastsProps<ContainerType extends Element, M extends ToastInfo> = GenericComponentProps<UseToastsReturnType<ContainerType, M>, Get2<UseToastsParameters, "managedChildrenParameters", "toastsParameters">, "visibleCount">;
