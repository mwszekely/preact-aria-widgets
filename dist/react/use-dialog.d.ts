import { ElementProps, TargetedOmit, UseModalParameters, UseModalReturnType, UsePressReturnType } from "preact-prop-helpers/react";
...
export interface UseDialogReturnType<FocusContainerElement extends Element, SourceElement extends Element, PopupElement extends Element, TitleElement extends Element> extends OmitStrong<UseModalReturnType<FocusContainerElement, SourceElement, PopupElement>, "propsStableSource" | "propsStablePopup">, Pick<UsePressReturnType<any>, "pressReturn"> {
