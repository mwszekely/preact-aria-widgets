import { OmitStrong } from "preact-prop-helpers/react";
...
export declare const Tab: <E extends Element>({ focusSelf, untabbable, index, getText, render, longPressThreshold, onPressingChange, imperativeHandle, onElementChange, onMount, onUnmount, onCurrentFocusedChanged, onCurrentFocusedInnerChanged, singleSelectionDisabled, onTextContentChange, info: uinfo, ...void1 }: TabProps<E, TabInfo<E>>) => import("preact").JSX.Element;
export declare const TabPanel: <E extends Element>({ index, render, info: uinfo }: TabPanelProps<E, TabPanelInfo>) => import("preact").JSX.Element;
