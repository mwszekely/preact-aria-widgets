...
export declare function Slider({ max, min, onAfterChildLayoutEffect, onChildrenMountChange, render, imperativeHandle, onChildrenCountChange, ...void1 }: SliderProps<SliderThumbInfo>): import("preact-prop-helpers").JSX.Element | import("react/jsx-runtime").JSX.Element;
export declare function SliderThumb<ThumbElement extends Element>({ label, tag, value, max, min, index, render, valueText, imperativeHandle, onValueChange, info, ...void1 }: SliderThumbProps<ThumbElement>): import("preact-prop-helpers").JSX.Element | import("react/jsx-runtime").JSX.Element;
