import { UseAsyncHandlerParameters } from "preact-prop-helpers/preact";
...
export declare const Progress: <IndicatorElement extends Element, LabelElement extends Element>({ tagProgressIndicator, ariaLabel, max, render, value, valueText, imperativeHandle, ...void1 }: ProgressProps<IndicatorElement, LabelElement>) => import("preact-prop-helpers").JSX.Element | import("react/jsx-runtime").JSX.Element;
export declare const ProgressWithHandler: <EventType, CaptureType, IndicatorElement extends Element, LabelElement extends Element>({ ariaLabel, forciblyPending, render, tagProgressIndicator, asyncHandler, capture, debounce, throttle, notifyFailure, notifyPending, notifySuccess, imperativeHandle, ...void1 }: ProgressWithHandlerProps<EventType, CaptureType, IndicatorElement, LabelElement>) => import("preact-prop-helpers").JSX.Element | import("react/jsx-runtime").JSX.Element;
export {};
