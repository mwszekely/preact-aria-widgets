...
export declare function Toasts<ContainerType extends Element>({ onAfterChildLayoutEffect, onChildrenMountChange, render, visibleCount, imperativeHandle, onChildrenCountChange, ...void1 }: ToastsProps<ContainerType, ToastInfo>): import("preact-prop-helpers").JSX.Element | import("react/jsx-runtime").JSX.Element;
export declare function Toast<E extends Element>({ render, index, timeout, politeness, children, info, imperativeHandle }: ToastProps<E, ToastInfo>): import("preact-prop-helpers").JSX.Element | import("react/jsx-runtime").JSX.Element;
