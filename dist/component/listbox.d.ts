...
export declare const ListboxItem: <ListboxItemElement extends Element, M extends ListboxInfo<ListboxItemElement> = ListboxInfo<ListboxItemElement>>({ disabled, focusSelf, getText, hidden, index, render, selected, getSortValue, allowRepeatPresses, excludeEnter, excludePointer, longPressThreshold, onPressSync, onPressingChange, ...subInfo }: ListboxItemProps<ListboxItemElement, M>) => VNode<{}>;
export {};
