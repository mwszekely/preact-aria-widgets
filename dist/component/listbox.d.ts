...
export declare const GroupedListbox: <LabelElement extends Element>({ ariaLabel, selectionLimit, orientation, render }: Pick<ListboxProps<any, any, LabelElement, any>, "ariaLabel" | "selectionLimit" | "render" | "orientation">) => import("preact").JSX.Element;
...
export declare const ListboxItem: <ListboxItemElement extends Element, M extends ListboxInfo<ListboxItemElement> = ListboxInfo<ListboxItemElement>>({ disabled, focusSelf, onPressSync, getText, hidden, index, render, selected, getSortValue, ...subInfo }: ListboxItemProps<ListboxItemElement, M>) => VNode<{}>;
export {};
