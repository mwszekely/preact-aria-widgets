...
interface TableRowPropsBase<RowElement extends Element, CellElement extends Element, RM extends TableRowInfo<RowElement, CellElement>, CM extends TableCellInfo<CellElement>> extends Pick<RM, "index" | "hidden" | "disabled">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "textContentParameters">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "tableRowParameters">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "linearNavigationParameters">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "rovingTabIndexParametersR2C"> {
...
export declare const TableSection: <SectionElement extends Element, RowElement extends Element, CellElement extends Element>({ disableHomeEndKeys, getIndex, initiallySelectedIndex, untabbable, navigatePastEnd, navigatePastStart, onSelectedIndexChange, onTabbableColumnChange, onTabbableIndexChange, pageNavigationSize, paginationMax, paginationMin, staggered, render, location, ariaPropName, selectionMode, tagTableSection }: TableSectionProps<SectionElement, RowElement, CellElement, TableRowInfo<RowElement, CellElement>, TableCellInfo<CellElement>>) => import("preact").JSX.Element;
export declare const TableRow: <RowElement extends Element, Cellement extends Element>({ index, getText, tagTableRow, disableHomeEndKeys, onTabbableIndexChange, navigatePastEnd, navigatePastStart, selected, hidden, disabled, initiallyTabbedIndex, untabbable, render }: TableRowProps<RowElement, Cellement, TableRowInfo<RowElement, Cellement>, TableCellInfo<Cellement>>, ref?: Ref<any>) => import("preact").JSX.Element;
