...
interface TableRowPropsBase<RowElement extends Element, CellElement extends Element, RM extends TableRowInfo<RowElement, CellElement>, CM extends TableCellInfo<CellElement>> extends Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "singleSelectionChildParameters">, Pick<CM, "index">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "rovingTabIndexChildParameters">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "textContentParameters">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "tableRowParameters">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "linearNavigationParameters">, Get<UseTableRowParameters<RowElement, CellElement, RM, CM>, "rovingTabIndexParameters"> {
    ref?: Ref<UseTableRowReturnType<RowElement, CellElement, RM, CM>>;
}
interface TableCellPropsBase<CellElement extends Element, CM extends TableCellInfo<CellElement>> extends Get<UseTableCellParameters<CellElement, CM>, "tableCellParameters">, Pick<CM, "index">, Get<UseTableCellParameters<CellElement, CM>, "gridNavigationCellParameters">, Get<UseTableCellParameters<CellElement, CM>, "rovingTabIndexChildParameters">, Get<UseTableCellParameters<CellElement, CM>, "textContentParameters"> {
