...
export declare const MenuItem: <MenuItemElement extends Element, M extends UseMenubarSubInfo<MenuItemElement> = UseMenubarSubInfo<MenuItemElement>>({ index, untabbable, getSortValue, onPress, getText, role, focusSelf, unselectable, render, info: uinfo }: MenuItemProps<MenuItemElement, M>, ref?: Ref<any>) => import("preact").JSX.Element;
export {};
