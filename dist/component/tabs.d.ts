...
interface TabPropsBase<TabElement extends Element, M extends TabInfo<TabElement>> extends Pick<M, "index" | "hidden" | "disabled">, Get<UseTabParameters<TabElement, M>, "sortableChildParameters">, Get<UseTabParameters<TabElement, M>, "textContentParameters"> {
...
export declare const Tab: <E extends Element, M extends TabInfo<E> = TabInfo<E>>({ disabled, focusSelf, hidden, index, getText, getSortValue, render, info: uinfo }: TabProps<E, M>, ref?: Ref<any>) => VNode<any>;
