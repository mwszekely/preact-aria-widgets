...
export declare const Tab: <E extends Element, M extends TabInfo<E> = TabInfo<E>>({ disabled, focusSelf, hidden, index, getText, getSortValue, render, selectionMode, info: uinfo }: TabProps<E, M>, ref?: Ref<any>) => VNode<any>;
