...
interface TabPropsBase<TabElement extends Element, M extends TabInfo<TabElement>> extends Pick<M, "index" | "untabbable" | "unselectable">, Get<UseTabParameters<TabElement, M>, "sortableChildParameters">, Get<UseTabParameters<TabElement, M>, "pressParameters">, Get<UseTabParameters<TabElement, M>, "textContentParameters"> {
