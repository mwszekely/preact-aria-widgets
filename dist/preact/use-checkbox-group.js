import { assertEmptyObject, focus, returnFalse, returnNull, returnZero, useCallback, useCompleteListNavigation, useCompleteListNavigationChild, useEffect, useLayoutEffect, useMemoObject, useMergedProps, useMonitoring, usePassiveState, useRef, useStableCallback, useStableGetter, useState } from "preact-prop-helpers";
/**
 *
 ...
 */
export function useCheckboxGroup({ linearNavigationParameters, rovingTabIndexParameters, checkboxGroupParameters: { orientation, ...void2 }, multiSelectionParameters, refElementParameters, typeaheadNavigationParameters, processedIndexManglerParameters, ...void1 }) {
 ...
 * @compositeParams
 */
export function useCheckboxGroupChild({ checkboxGroupChildParameters, context, info: { focusSelf, index, untabbable, ...void3 }, textContentParameters, hasCurrentFocusParameters, refElementParameters, multiSelectionChildParameters: { multiSelectionDisabled, onMultiSelectChange, ...void5 }, ...void4 }) {
