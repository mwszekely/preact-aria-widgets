...
import { EnhancedEventHandler, OmitStrong, Prefices, TargetedEnhancedEvent, useMonitoring } from "./props.js";
...
export function useCheckbox<LP extends LabelPosition, InputType extends Element, LabelType extends Element>({
    ...
    return useMonitoring(function useCheckbox(): UseCheckboxReturnType<InputType, LabelType> {
        ...
        return {
            checkboxReturn: { propsUnstable: { type: (tagInput == "input" && labelPosition != "wrapping" ? "checkbox" : undefined) } as {} },
