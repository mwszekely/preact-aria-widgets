...
export interface MenuProps<SurfaceElement extends Element, MenuElement extends Element, SentinelElement extends Element, MenuItemElement extends Element, ButtonElement extends Element> extends //Omit<UseAriaMenuParameters<E, K, I>, "indexMangler" | "indexDemangler" | "onAfterChildLayoutEffect" | "onChildrenMountChange" | "onTabbableIndexChange" | "onTabbableRender" | "onTabbedInTo" | "onTabbedOutOf"> & {
    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "menu">,
    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "menuSurface">,
    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "softDismiss">,
    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "linearNavigation">,
    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "listNavigation">,
    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "rovingTabIndex">,
    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "typeaheadNavigation">,

    Get<UseAriaMenuParameters<SurfaceElement, ButtonElement, never>, "managedChildren"> {
    ...
    render(menuInfo: UseAriaMenuReturnTypeInfo<SurfaceElement, MenuElement, MenuItemElement, ButtonElement>, modifyMenuButtonProps: PropModifier<ButtonElement>, modifyMenuSurfaceProps: PropModifier<SurfaceElement>, modifyMenuProps: PropModifier<MenuElement>, modifyFirstSentinelProps: PropModifier<SentinelElement>, modifyLastSentinelProps: PropModifier<SentinelElement>): VNode;
}

export interface MenuItemProps<MenuItemElement extends Element> extends
    Get<UseAriaMenuItemParameters<MenuItemElement>, "managedChild">,
    Get<UseAriaMenuItemParameters<MenuItemElement>, "listNavigation">,
    Get<UseAriaMenuItemParameters<MenuItemElement>, "rovingTabIndex"> {
    render(info: UseAriaMenuItemReturnTypeInfo<MenuItemElement>, modifyListItemProps: PropModifier<MenuItemElement>): VNode;
    //tagMenuItem: any;
...
export function Menu<SurfaceElement extends Element, ParentElement extends Element, SentinelElement extends Element, ChildElement extends Element, ButtonElement extends Element>({
    ...
    const {
        ...
        useMenuSurfaceProps,
        ...menuReturn
    } = useAriaMenu<SurfaceElement, ParentElement, ChildElement, ButtonElement>({
        ...
        hasFocusButton: { getDocument, getWindow },
        hasFocusSurface: { getDocument, getWindow },
    });
...
export function defaultRenderMenu<SurfaceElement extends Element, MenuElement extends Element, MenuItemElement extends Element, SentinelElement extends Element, ButtonElement extends Element>({ portalId, tagButton, tagMenu, tagSurface, tagSentinel, makePropsButton, makePropsMenu, makePropsSurface, makePropsSentinel }: { portalId: string, tagSurface: ElementToTag<SurfaceElement>, tagMenu: ElementToTag<MenuElement>, tagButton: ElementToTag<ButtonElement>, tagSentinel: ElementToTag<SentinelElement>, makePropsSurface: (info: UseAriaMenuReturnTypeInfo<SurfaceElement, MenuElement, MenuItemElement, ButtonElement>) => h.JSX.HTMLAttributes<SurfaceElement>, makePropsMenu: (info: UseAriaMenuReturnTypeInfo<SurfaceElement, MenuElement, MenuItemElement, ButtonElement>) => h.JSX.HTMLAttributes<MenuElement>, makePropsButton: (info: UseAriaMenuReturnTypeInfo<SurfaceElement, MenuElement, MenuItemElement, ButtonElement>) => h.JSX.HTMLAttributes<ButtonElement>, makePropsSentinel: (info: UseAriaMenuReturnTypeInfo<SurfaceElement, MenuElement, MenuItemElement, ButtonElement>) => h.JSX.HTMLAttributes<SentinelElement> }) {
    return function (menuInfo: UseAriaMenuReturnTypeInfo<SurfaceElement, MenuElement, MenuItemElement, ButtonElement>, modifyMenuButtonProps: PropModifier<ButtonElement>, modifyMenuSurfaceProps: PropModifier<SurfaceElement>, modifyMenuProps: PropModifier<MenuElement>, modifyFirstSentinelProps: PropModifier<SentinelElement>, modifyLastSentinelProps: PropModifier<SentinelElement>) {
...
export function defaultRenderMenuItem<MenuItemElement extends Element>({ makePropsMenuItem: makePropsMenuItem, tagMenuItem }: { tagMenuItem: ElementToTag<MenuItemElement>, makePropsMenuItem: (info: UseAriaMenuItemReturnTypeInfo<MenuItemElement>) => h.JSX.HTMLAttributes<MenuItemElement> }) {
    return function (info: UseAriaMenuItemReturnTypeInfo<MenuItemElement>, modifyMenuItemProps: PropModifier<MenuItemElement>) {
