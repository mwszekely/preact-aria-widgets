(function () {
    ...
    */
     ...
     * @returns
     */
    function useSoftDismiss({ onClose, elements }) {
    ...
    function useModal({ open, onClose }) {
        ...
        const { useRefElementProps: useModalRefElement, element: modalElement } = useRefElement();
    ...
    function useAriaMenu({ collator, keyNavigation, noTypeahead, noWrap, typeaheadTimeout, ...args }) {
        ...
        const { element: buttonElement, useRefElementProps: useButtonRefElementProps } = useRefElement();
        const { element: menuElement, useRefElementProps: useMenuRefElementProps } = useRefElement();
        ...
        const useMenuButton = F(({}) => {
            useLayoutEffect(() => { setOpenerElement(buttonElement); }, [buttonElement]);
            return {
