	...
	*/
	...
	function useAriaAccordion({ expandedIndex, setExpandedIndex }) {
	    ...
	    const useAriaAccordionSection = A$1((args) => {
	        ...
	        function useAriaAccordionSectionHeader({ tag }) {
