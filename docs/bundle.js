(function () {
	...
	*/
	...
	function useRovingTabIndex({ tabbableIndex }) {
	    ...
	    const { managedChildren, useManagedChild } = useChildManager();
	    ...
	    const useRovingTabIndexChild = A$1((info) => {
	        ...
	        function useRovingTabIndexChildProps({ tabIndex, ...props }) {
	            ...
	            return useMergedProps()(useRefElementProps({ tabIndex }), props);
	        }
	        return {
	...
	function useListNavigation({ collator, keyNavigation }) {
	    ...
	    const { childCount, managedChildren, useRovingTabIndexProps, useRovingTabIndexChild, focusSelf } = useRovingTabIndex({ tabbableIndex: tabbableIndex });
	...
	*/
	...
	function useAriaAccordian({ expandedIndex, setExpandedIndex }) {
	    ...
	    const useAriaAccordianSection = A$1((args) => {
	        ...
	        useManagedChildSection({ ...args, setOpenFromParent, focus });
	        ...
	        function useAriaAccordianSectionHeader() {
	            ...
	            function useAriaAccordianSectionHeaderProps({ ["aria-expanded"]: ariaExpanded, ["aria-disabled"]: ariaDisabled, ...props }) {
	                ...
	                let ret0 = useHasFocusProps(useRefElementProps(props));
	...
	function useAriaButton({ tag, pressed, onClick: onClickAsync, debounce }) {
	    const { onClick, ...asyncInfo } = useAsyncHandler()({ capture: () => pressed == undefined ? pressed : !pressed, event: "onClick", debounce })(onClickAsync);
	...
	function useAriaCheckbox({ labelPosition, checked, onInput: onInputAsync, disabled }) {
	    const { onInput, ...asyncInfo } = useAsyncHandler()({ event: "onInput", capture: e => !checked })(onInputAsync);
	...
	*/
	...
	function useAriaListboxSingle({ selectedIndex, onSelect, selectionMode, ...args }) {
	    ...
	    const { useListNavigationChild, useListNavigationProps, navigateToIndex, managedChildren } = useListNavigation(args);
	    ...
	    const useListboxSingleItem = A$1((info) => {
	        ...
	        const { onClick: onSelect, ...asyncInfo } = useAsyncHandler()({ event: "onClick", capture: (e) => info.index })(stableOnSelect);
	...
	function useAriaListboxMulti({ ...args }) {
	    ...
	    const useListboxMultiItem = A$1((info) => {
	        ...
	        const { onClick: onSelect, ...asyncInfo } = useAsyncHandler()({ event: "onClick", capture: e => !selected })(onSelectAsync);
	...
	function useAriaMenu({ collator, keyNavigation, noTypeahead, noWrap, typeaheadTimeout, ...args }) {
	    ...
	    const useMenuItem = A$1((args) => {
	        ...
	        const { onClick, ...asyncInfo } = useAsyncHandler()({ capture: _ => void (0), event: "onClick" })(args.onClick);
	    ...
	    const useMenuItemCheckbox = A$1((args) => {
	        const { onClick, ...asyncInfo } = useAsyncHandler()({ capture: _ => !args.checked, event: "onClick" })(args.onChange);
	        function useAriaMenuItemProps({ ...props }) {
	...
	function useAriaTabs({ selectionMode, selectedIndex, onSelect: asyncOnSelect, ...args }) {
	    ...
	    const useTab = A$1(function useTab(info) {
	        ...
	        const [selected, setSelected, getSelected] = useState(false);
	        const { tabbable, useListNavigationChildProps, useListNavigationSiblingProps } = useListNavigationChild({ ...info, setSelected, tabId, setTabPanelId });
	        const { onClick: onSelect, ...asyncInfo } = useAsyncHandler()({ event: "onClick", capture: (e) => info.index })(stableAsyncOnSelect);
	        y(() => {
	            if (tabbable && selectionMode == "focus") {
	                onSelect?.bind(null)(null);
	            }
	        ...
	        function useTabProps({ ...props }) {
	            ...
	            return useMergedProps()({}, useTabIdProps(useListNavigationChildProps(newProps)));
	        }
	        return { useTabProps };
	    }, []);
	    const useTabPanel = A$1(function usePanel(info) {
	        ...
	        function useTabPanelProps({ ...props }) {
	            ...
	            return useMergedProps()({}, usePanelIdProps(useRefElementProps(props)));
	        }
	...
	const DemoUseAsyncHandler1 = g(() => {
	    ...
	    const { callCount, settleCount, getCurrentCapture, hasCapture, onClick, currentCapture, pending, error, hasError, rejectCount, resolveCount } = useAsyncHandler()({ event: "onClick", capture: () => { }, debounce: debounce == 0 ? undefined : debounce })(async (v, e) => new Promise((resolve, reject) => window.setTimeout(() => getShouldThrow() ? reject() : resolve(), timeout)));
	    return (v$1("div", { className: "demo" },
	...
	const DemoUseAsyncHandler2 = g(() => {
	    ...
	    const { callCount, settleCount, getCurrentCapture, hasCapture, onInput, currentCapture, pending, error, hasError, rejectCount, resolveCount } = useAsyncHandler()({ event: "onInput", capture: e => { e.preventDefault(); return e.currentTarget.value; }, debounce: debounce == 0 ? undefined : debounce })(async (v, e) => new Promise((resolve, reject) => window.setTimeout(() => {
	        if (getShouldThrow()) {
	            reject();
	        }
	        else {
