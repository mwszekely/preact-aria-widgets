(function () {
    ...
    */
    ...
    function useTable({}) {
        ...
        // keyboard inputs
        function useTableProps({ role, ...props }) { return useHasFocusProps(useMergedProps()({ role: "group", "aria-roledescription": "table" }, props)); }
        /**
         *
        ...
        const useTableRow = A$1(({ rowIndex: rowIndexAsUnsorted, location }) => {
            ...
            const useTableCellShared = A$1(({ index: columnIndex, value }) => {
                ...
                function useTableCellProps({ role, ...props }) {
                    return (useMergedProps()({ role: "gridcell", "aria-roledescription": "table cell" }, props));
                }
            ...
            const useTableHeadCell = A$1(({ columnIndex, unsortable, tag }) => {
                const { useTableCellDelegateProps, useTableCellProps } = useTableCellShared({ index: columnIndex, value: "" });
    ...
    const DemoTable = g(() => {
        ...
        const rows = Array.from(function* () {
            for (let i = 0; i < 10; ++i) {
                yield v$1(TableRow, { index: i + 1 });
            }
        }());
        return (v$1(TableRowContext.Provider, { value: useTableRow },
            v$1("table", { ...useTableProps({}) },
                v$1("thead", { ...useTableHeadProps({ children: [v$1(TableHeaderRow, { index: 0 })] }) }),
    ...
    function TableRow({ index }) {
        ...
        return (v$1("tr", { ...useTableRowProps({}) },
    ...
    function TableHeaderRow({ index }) {
        ...
        return (v$1("tr", { ...useTableHeadRowProps({}) },
            v$1("th", { ...useTableHeadCellProps1(useTableHeadCellDelegateProps1({})) }, "Number"),
            v$1("th", { ...useTableHeadCellProps2(useTableHeadCellDelegateProps2({})) }, "String"),
            v$1("th", { ...useTableHeadCellProps3(useTableHeadCellDelegateProps3({})) }, "Date")));
    }
    const Component = () => {
