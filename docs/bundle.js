	...
	*/
	...
	function useAriaTabs({ selectionMode, selectedIndex, onSelect: asyncOnSelect, ...args }) {
	    ...
	    const useTabPanel = A$1(function usePanel(info) {
	        ...
	        const { element, useManagedChildProps } = useManagedTabPanel({ ...info, tabPanelId, setTabId, focus });
	        function focus() {
	...
	const DemoTabPanel = g(({ index }) => {
	    ...
	    const { useTabPanelProps } = useTabPanel({ index, setVisible, visible });
