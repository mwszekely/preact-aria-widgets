    ...
    function useAriaTooltip({ mouseoverDelay }) {
        ...
        const useTooltipTrigger = F(function useTooltipTrigger() {
            ...
            function useTooltipTriggerProps({ ...props }) {
                ...
                props.tabIndex ??= -1;
                return useTooltipIdReferencingProps("aria-describedby")(useHasFocusProps(useMergedProps()({ onPointerEnter, onPointerLeave, onClick }, props)));
            }
