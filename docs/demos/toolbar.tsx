    ...
    return (
        <ToolbarChild
            ...
            render={({ rovingTabIndex: { tabbable } }, modifyProps) => {
                return <Button getDocument={getDocument} tagButton="button" render={defaultRenderButton("button", () => modifyProps({ "data-tabbable": tabbable.toString(), children: `Button #${index}` }))} />
            }}
        />
    )
})
